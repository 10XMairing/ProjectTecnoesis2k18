...
import com.tecnoesis.tecnoesisApp.tecnoesis2k18.ListItems.EventItem;
import com.tecnoesis.tecnoesisApp.tecnoesis2k18.ListItems.HeaderItem;
import com.tecnoesis.tecnoesisApp.tecnoesis2k18.ListItems.ListItem;
import com.tecnoesis.tecnoesisApp.tecnoesis2k18.R;
import com.tecnoesis.tecnoesisApp.tecnoesis2k18.Utils.Models.Event;
import com.tecnoesis.tecnoesisApp.tecnoesis2k18.Utils.Models.ModuleEvent;
import com.tecnoesis.tecnoesisApp.tecnoesis2k18.Utils.Models.Workshop;
...
public class EventsUtils {
    ...
    public static List<TeamHeader> getTeamList(){
        List<TeamMember> list1 = new ArrayList<>();
        List<TeamHeader> list = new ArrayList<>();
        list1.add(new TeamMember("Prof. Sivaji Bandyopadhyay", "Director, NITS\n" +
                "Chief Patron",R.drawable.director));
        list1.add(new TeamMember("Prof. R.D. Misra", "Dean(SW), NITS\n" +
                "Chairman",R.drawable.deansw));
        ...
        list1 = new ArrayList<>();
        list1.add(new TeamMember("Shivam Singh", "Executive Head",R.drawable.shivam));
        list1.add(new TeamMember("Mridupawan Deka", "Executive Head",R.drawable.mridu));
        list1.add(new TeamMember("Kunal Sarkar", "Executive Head",R.drawable.kunal));
        list.add(new TeamHeader("Executive", list1));

        list1 = new ArrayList<>();
        list1.add(new TeamMember("Nitish Dash", "Technical Head",R.drawable.nitish));
        list1.add(new TeamMember("Samim Jahin", "Technical Coordinator",R.drawable.samim));
        ...
        list.add(new TeamHeader("Android Team", list1));

        list1 = new ArrayList<>();
        list1.add(new TeamMember("Abdullah Khilji", "Web Developer",R.drawable.khilji));
        list1.add(new TeamMember("Tukan Dutta", "Web Developer",R.drawable.tukan));
        list1.add(new TeamMember("Basabee Bora", "Web Developer",R.drawable.basabee));
        list.add(new TeamHeader("Web Team", list1));


        list1 = new ArrayList<>();
        list1.add(new TeamMember("Samim Jahin", "Design Head",R.drawable.samim));
        list1.add(new TeamMember("Priyam Bhardwaj", "Design Head",R.drawable.priyam));
        list.add(new TeamHeader("Design", list1));

        list1 = new ArrayList<>();
        list1.add(new TeamMember("Makarand Patil", "Designer",R.drawable.patil));
        list1.add(new TeamMember("Tushar Agarwal", "Designer",R.drawable.tushar));
        list1.add(new TeamMember("Ashapriya Borgohain", "Designer",R.drawable.asha));
        list1.add(new TeamMember("Akashjyoti Hazarika", "Designer",R.drawable.akash));
        list1.add(new TeamMember("Dixita Sarkar", "Designer",R.drawable.dixita));
        list.add(new TeamHeader("Designers", list1));

        list1 = new ArrayList<>();
        list1.add(new TeamMember("Shahrukh Sohail", "Infra Head",R.drawable.sohail));
        list1.add(new TeamMember("Manabendra Das", "Infra Head",R.drawable.manab));
        list1.add(new TeamMember("Ayan Neel Medhi", "Infra Head",R.drawable.ayan));
        list1.add(new TeamMember("Deep Das", "Content Head",R.drawable.deep));
        list1.add(new TeamMember("Shambhavi Upadhyay", "Content Head",R.drawable.sham));
        list.add(new TeamHeader("Heads", list1));

        list1 = new ArrayList<>();
        list1.add(new TeamMember("Mayukh Paul", "Publicity And PR Head",R.drawable.mayukh));
        ...
        list1 = new ArrayList<>();
        list1.add(new TeamMember("Prabhu Datta Mohanty", "Marketing Head",R.drawable.prabhu));
        ...
        list.add(new TeamHeader("Decoration", list1));

        list1 = new ArrayList<>();
        list1.add(new TeamMember("Arnab Parasar", "Hospitality Head",R.drawable.arnab));
